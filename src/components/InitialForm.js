...
const InitialForm = ({onSubmitForm, nameToFeedback, handleInputName, targetNameToFeedback, handleInputTargetName, feedbackType, setFeedbackType, setTargetNameToFeedback}) => {
    ...
    return (
    	<form className="form" onSubmit={onSubmitForm}>
            ...
            <input value={targetNameToFeedback} disabled={feedbackType === "autoAvaliacao"} onChange={handleInputTargetName} className="inputName" placeholder="Quem será avaliado?" required={feedbackType !== 'autoAvaliacao'}  maxLength={40} type="text" />
